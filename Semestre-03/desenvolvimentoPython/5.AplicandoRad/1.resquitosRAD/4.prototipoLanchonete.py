...
class SaborRapidoApp:
    def __init__(self, root):
        ...
        # Cada botão irá desencandiar uma função
        ...
        tk.Label(root, text="Adicionar Novo Intem ao Menu", font=("Arial", 12)).pack(pady=10)
    ...
    def adicionar_pedido(self):
        ...
        messagebox.showinfo("Pedido", "Items adicionados com sucesso!")
    ...
    def adicionar_item_menu(self):
        ...
        if item and preco:
            try:
                ...
                messagebox.showinfo("Sucesso", "Item adicionado ao menu!")
            
            except ValueError:
                messagebox.showerror("Erro", "Preco inválido. Difite um valor numérico.")
