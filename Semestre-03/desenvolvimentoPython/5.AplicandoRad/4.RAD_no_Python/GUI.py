...
class PrincipalRAD:
    def __init__(self, win): #win de windows (janela)
        # Compomentes
        ...
        # Entradas
        self.txtNome = tk.Entry(bd=3) # Cria um campo de entrada com borda de 3 pixesl
        ...
        # Cria um widget Treeview para exibir os dados dos alunos e suas médias
        self.treeMedias = ttk.Treeview(win, columns=self.dadosColunas, selectmode="browse")
        
        # Adiciona a barra de rolagem à janela, posicionando-a à direita e preenchendo no eixo x
...
# -------------------------
# Calcula a media e verifica qual é a situação do aluno
# -------------------------
...
# -------------------------
    ...
    def fCalcularMedia(self):
        try:
            ...
            print("Erro: Certifique-se de que as notas são números válidos.")
